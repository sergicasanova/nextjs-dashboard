  ...
  return (
    <div className="w-full md:col-span-4">
      ...
      {<div className="rounded-xl bg-gray-800 p-4">
        <div className="sm:grid-cols-13 mt-0 grid grid-cols-12 items-end gap-2 rounded-md bg-gray-200 p-4 md:gap-4">
          <div
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <h3 className="ml-2 text-sm text-gray-200 ">Last 12 months</h3>
        </div>
      </div>}
    </div>
  );
